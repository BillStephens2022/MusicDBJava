...
public class Datasource {
    ...
    public static final String CREATE_ARTIST_BY_SONG_VIEW = "CREATE VIEW IF NOT EXISTS " +
    ...
    public static final String QUERY_VIEW_SONG_INFO = "SELECT " + COLUMN_ALBUM_NAME + ", " +
            COLUMN_SONG_ALBUM + ", " + COLUMN_SONG_TRACK + " FROM " + TABLE_ARTIST_SONG_VIEW +
            " WHERE " + COLUMN_SONG_TITLE + " = \"";

    public static final String QUERY_VIEW_SONG_INFO_PREP = "SELECT " + COLUMN_ALBUM_NAME + ", " +
            COLUMN_SONG_ALBUM + ", " + COLUMN_SONG_TRACK + " FROM " + TABLE_ARTIST_SONG_VIEW +
            " WHERE " + COLUMN_SONG_TITLE + " = ?";
    ...
    public boolean createViewBySongArtist() {
        try (Statement statement = conn.createStatement()) {
            statement.execute(CREATE_ARTIST_BY_SONG_VIEW);
            return true;
        } catch (SQLException e) {
